      ...
      <header className="bg-white border-b border-slate-200 px-6 py-4 flex justify-between items-center sticky top-0 z-10">
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-slate-400 text-[8px] font-bold uppercase tracking-widest mt-1">ASBJKT TECHNOLOGY • Beta 1.5.4</span>
          </div>
        </div>
        ...
        {view === 'checkout' && (
          <div className="w-full bg-white p-6 rounded-3xl shadow-xl border border-slate-200">
             ...
             <div className="space-y-4">
                ...
                <button onClick={handleCheckout} className="w-full bg-blue-600 text-white font-bold py-4 rounded-xl shadow-lg hover:bg-blue-700">Complete Checkout</button>
             </div>
          </div>
        )}
        ...
        {view === 'check-in' && (
          <div className="w-full bg-white p-6 rounded-3xl shadow-xl border border-slate-200">
             ...
             <div className="space-y-4">
                ...
                <button onClick={handleCheckin} className="w-full bg-emerald-500 text-white font-bold py-4 rounded-xl shadow-lg hover:bg-emerald-600">Confirm Check In</button>
             </div>
          </div>
        )}
             ...
             <div className="mt-8">
                {checkedOutList.length === 0 ? (
                  ...
                  <div className="bg-white rounded-2xl border border-slate-200 p-4 flex flex-col gap-2 shadow-sm">
                    <h3 className="font-bold text-slate-700 mb-2 px-2">Currently Borrowed:</h3>
                    {checkedOutList.map(num => (
                      <div key={num} className="p-4 bg-blue-50 border border-blue-100 text-blue-800 rounded-xl font-bold flex items-center justify-between">
                        <span>Chromebook #{num}</span>
